...
<CardGrid>
  ...
  />
  <LinkCard
    title="hash it out (store)"
    href="https://whop.com/hash-it-out/"
    description="Reports, guides, and membership -- Arc's paid research surface."
  />
  <LinkCard
    title="Subscribe"
    href="/subscribe/"
    description="Free findings digest by email -- no marketing, drawn from the research corpus."
  />
</CardGrid>
